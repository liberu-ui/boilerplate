...
import MissingKey from '@liberu-ui/localisation/bulma/components/navbar/MissingKeys.vue';
import KeyCollector from '@liberu-ui/localisation/bulma/components/settings/KeyCollector.vue';
import LanguageSelector from '@liberu-ui/localisation/bulma/components/settings/LanguageSelector.vue';
const app = createApp({});
